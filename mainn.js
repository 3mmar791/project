...
function saveCartItems() {
  ...
  for (var i = 0; i < cartBoxes.length; i++) {
    ...
    var priceElement = cart.getElementsByTagName("cart-price")[0];
...
function loadCartItems() {
  ...
  if (cartItems) {
    ...
    for (var i = 0; i < cartItems.length; i++) {
      ...
      var quantitiyElement = cartBox.getElementsByClassName("cart-quantity")[0];
      quantitiyElement.value = item.quantity;
    }
  }
